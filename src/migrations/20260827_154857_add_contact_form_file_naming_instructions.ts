...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "site_locales" ADD COLUMN "contact_form_file_naming_instructions" varchar DEFAULT 'For laser cutting files, use this naming format: Material_Thickness_File name - Quantity.' NOT NULL;
  UPDATE "site_locales"
