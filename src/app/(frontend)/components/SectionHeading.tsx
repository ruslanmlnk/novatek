...
export function SectionHeading({ align = 'split', button, eyebrow, title }: SectionHeadingProps) {
  const wrapperClass =
    align === 'split'
      ? 'mx-auto mb-12 flex max-w-content items-center justify-between gap-8 max-md:flex-col max-md:items-start'
      : 'mx-auto mb-12 block max-w-content'

  return (
    <div className={wrapperClass}>
      <div>
        <p className="mb-4 text-lg font-medium leading-[1.45] text-white">// {eyebrow} //</p>
        <h2 className="max-w-[760px] text-[48px] font-semibold leading-[60px] tracking-normal text-white max-md:text-[34px] max-md:leading-10 [&_span]:text-novatek-primary">
