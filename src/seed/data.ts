...
export const services: SeedService[] = [
  ...
  },
  {
    ...
    heroTitle: { before: 'Precision ', accent: 'CNC machining', after: ' for custom mechanical components' },
    overviewHeading: 'Precision CNC machining',
    overview:
      'Our CNC machining services deliver custom mechanical parts, production fixtures and industrial components with industrial-grade accuracy. Modern milling equipment and tolerance-focused engineering review keep every part consistent with the drawing.\nFrom single prototypes to repeat production runs, we support complex geometries, tight tolerances and practical material choices.\nEvery project is planned around function and manufacturability, so machined parts arrive ready for assembly and reliable long-term use.',
    cards: [
      { title: 'Precision milling', description: 'CNC milling with industrial-grade machining accuracy' },
      { title: 'Complex geometries', description: 'Support for demanding shapes, pockets and tight tolerances' },
      { title: 'Multiple materials', description: 'Steel, stainless steel, aluminum and engineering plastics' },
      { title: 'Fast turnaround', description: 'Efficient production planning with reliable delivery timelines' },
    ],
    industries: [
      { industry: 'Industrial Manufacturing', applications: ['Machine parts', 'Production fixtures', 'Tooling components', 'Mechanical assemblies'] },
      { industry: 'Engineering & Prototyping', applications: ['Functional prototypes', 'Custom technical parts', 'Small production batches', 'Test components'] },
      { industry: 'Equipment Maintenance', applications: ['Replacement parts', 'Worn component remanufacturing', 'Machine upgrades', 'Custom adapters'] },
    ],
  },
  {
    title: '3D Scanning',
